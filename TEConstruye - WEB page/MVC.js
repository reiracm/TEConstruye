...
//-------------------------------------------------------------------------------------
  ...
  main_module.controller('adminController',function ($scope){
    ...
    $scope.material_list = [];
    $scope.stage_list = [];
    $scope.role_list = [{Name_: 'Ingeniero', ID:'2'},{Name_: 'Administrados', ID:'1'},{Name_: 'Peon', ID:'3'}];
    ...
    $scope.client_template = {Fname:'', Sname:'', Lname:'', Email:'', Password_:'', IDPhone:'', ID:''};
    ...
    $scope.assignProjectExpense= function(){
      ...
      input['IDProject'] = document.getElementById("purchase_project_select").value;
      input['IDStage'] = document.getElementById("purchase_stage_select").value;
